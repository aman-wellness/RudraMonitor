    ...
    <PartnerLayout title="Profile">
      ...
      <section className="bg-dark-800 border border-dark-700 rounded-xl p-5 mb-5">
        ...
        <p className="text-[11px] text-gray-500 mt-4 max-w-xl">
          ...
          Your name, billing email, status and commission rate are managed by Rudrans admins. To change any of these, contact <a href="mailto:itsupport@rudrans.com" className="text-violet-400">itsupport@rudrans.com</a>.
        </p>
      </section>
