  ...
  return (
    <AdminLayout title="Marketing AI">
      <div className="space-y-4">
        ...
        {/* Status banner */}
        <div className="bg-gradient-to-br from-purple-500/10 to-cyan-500/10 border border-purple-500/25 rounded-xl p-5">
          <div className="flex items-start justify-between gap-3 flex-wrap">
            <div>
              <div className="flex items-center gap-2 mb-2">
                <i className="ri-megaphone-line text-purple-400 text-lg" />
                <p className="text-[11px] uppercase tracking-wider text-purple-300 font-medium">
              ...
              <p className="text-sm text-gray-300">
                Daily 30-second video + post · Weekly 5-minute long video. Generated by GPT-4o, DALL-E 3, OpenAI TTS, assembled by ffmpeg.
              </p>
              <p className="text-[11px] text-gray-500 mt-1">
                Today is {today}. {todayDrafts.length === 0 ? 'No draft generated yet — daily cron fires at 06:00 UTC.' : `${todayDrafts.length} draft${todayDrafts.length === 1 ? '' : 's'} ready for review.`}
              </p>
            </div>
            <button
              onClick={() => void refresh()}
              disabled={loading}
              className="text-xs px-3 py-1.5 rounded-md bg-dark-700 hover:bg-dark-600 text-white border border-dark-600 disabled:opacity-50"
            >
