    ...
    <AdminLayout title="DLP Alerts">
      <div className="space-y-4">
        ...
        <div className="bg-dark-800 border border-dark-700 rounded-xl p-5 space-y-3">
          <div>
            <h2 className="text-sm font-semibold text-white">Global alert recipients (TrackForce ops)</h2>
          ...
          <div className="flex flex-col sm:flex-row gap-2">
            ...
            <input value={newEmail} onChange={(e) => setNewEmail(e.target.value)} type="email" placeholder="security@trackforce.in" className="flex-[2] bg-dark-900 border border-dark-700 rounded-lg px-3 py-2 text-sm text-white" />
