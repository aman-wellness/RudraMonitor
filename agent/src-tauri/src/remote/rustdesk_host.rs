...
// Public key of our hbbs container, auto-generated by the rustdesk-server
// image on first boot and stored in /opt/wellness-extract/rustdesk on EC2. Pinning
// it in the config means: (a) clients refuse to talk to a rogue relay
// impersonating api-ems.wellnessextract.com, (b) "key mismatch" errors disappear —
// previously customers had to paste this key into RustDesk's Settings UI
// by hand which is a non-starter for a managed-agent deployment.
const HBBS_PUBKEY: &str = "N9YabDaxaMGLRZe0ImMg7A+erwbHnklEQeQviQA+E7s=";
